...
const TOPIC_QUOTES: Record<string, string> = {
  "tình yêu": "Lắng nghe tiếng vọng của nhân duyên tiền định.",
  "sự nghiệp": "Vén màn bí mật phía sau những ngã rẽ.",
  "tài chính": "Khơi thông dòng chảy năng lượng thịnh vượng.",
