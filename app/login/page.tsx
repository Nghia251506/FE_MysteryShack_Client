...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    ...
    window.location.href =
      "https://api.mystictarots.xyz/oauth2/authorization/google";
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // --- THẤT BẠI (THÊM ĐOẠN NÀY VÀO ĐÂY) ---
      ...
      if (serverError?.message === "Bad credentials") {
        ...
        const msg =
          typeof serverError === "string" ? serverError : "Đã có lỗi xảy ra";
        showToast(msg, "error");
      }
    }
  };
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-slate-400 italic mb-8">
                ...
                đang được các pháp sư thiết lập cổ trận. Hãy sử dụng phương thức
                truyền thống để đăng nhập vào cõi Mystic."
              </p>
          ...
          <Card className="relative w-full bg-[#0f0a19]/90 border-white/10 backdrop-blur-xl shadow-2xl">
            <CardHeader className="space-y-3 text-center pb-6 pt-8">
              ...
              <CardDescription className="text-slate-400 text-sm">
                Nhập thông tin để kết nối năng lượng
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center px-1">
                    ...
                    <Link
                      ...
                      className="text-[10px] text-amber-500/50"
                    >
                      Quên mật khẩu?
                    </Link>
                  </div>
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#0f0a19] px-2 text-slate-500">
                    Hoặc tiếp tục với
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-3 mb-6">
                <Button
                  ...
                  variant="outline"
                  className="h-11 border-white/10 bg-white/5 text-slate-300 hover:bg-white/10 hover:text-white transition-all flex items-center justify-center group"
                >
                  {/* Icon Google với màu tách dải chuẩn logo gốc */}
                  <FaGoogle className="text-lg transition-transform duration-300 group-hover:scale-110 fill-[url(#google-multi-color)]" />

                  <svg width="0" height="0" className="absolute">
                    <linearGradient
                      id="google-multi-color"
                      x1="0%"
                      y1="0%"
                      x2="100%"
                      y2="100%"
              ...
              <div className="text-center">
                <p className="text-slate-500 text-sm">
                  ...
                  <Link
                    ...
                    className="text-amber-500 hover:text-amber-400 font-bold transition-colors hover:underline"
                  >
                    Đăng ký ngay
                  </Link>
                </p>
