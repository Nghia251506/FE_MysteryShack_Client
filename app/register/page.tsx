            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <Label
                    htmlFor="fullName"
                    className="text-slate-300 text-xs uppercase tracking-wider font-semibold ml-1"
                  >
                    Họ và tên
                  </Label>
                  <div className="relative group/input">
                    ...
                    <Input
                      ...
                      className="h-10 pl-10 bg-slate-950/50 border-white/10 text-slate-100 focus:border-amber-500/50 transition-all"
                      required
                      disabled={loading}
                    />
                  </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group/input">
                    ...
                    <Input
                      ...
                      className="h-10 pl-10 bg-slate-950/50 border-white/10 text-slate-100 focus:border-amber-500/50 transition-all [color-scheme:dark]"
                      required
                      disabled={loading}
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative group/input">
                      ...
                      <Input
                        ...
                        className="h-10 pl-10 pr-8 bg-slate-950/50 border-white/10 text-slate-100 focus:border-amber-500/50 transition-all"
                        required
                        disabled={loading}
                      />
                      <button
                ...
                <div className="flex items-center gap-3 py-2 px-3 rounded-lg bg-amber-500/5 border border-amber-500/10 mb-2">
                  <Checkbox
                    id="isReader"
                    checked={formData.isReader}
                    onCheckedChange={(checked) =>
                      setFormData({ ...formData, isReader: checked as boolean })
                    }
                    disabled={loading}
                    className="border-amber-500/50 data-[state=checked]:bg-amber-600"
                  />
                  <div className="grid gap-1.5 leading-none">
                    <Label
                      htmlFor="isReader"
                      className="text-sm text-amber-200 cursor-pointer font-semibold flex items-center gap-2"
                    >
                      Tôi muốn trở thành Reader Tarot{" "}
                      <Sparkles className="w-3.5 h-3.5 text-amber-400" />
                    </Label>
                    <p className="text-[10px] text-slate-500 italic">
                      (Bạn cần tham gia bài kiểm tra năng lực sau khi đăng ký)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 py-2">
                  <Checkbox
                    ...
                    disabled={loading}
                    className="mt-0.5 border-white/20 data-[state=checked]:bg-amber-600"
                  />
                  <Label
                    htmlFor="terms"
                    className="text-xs text-slate-400 leading-relaxed cursor-pointer font-normal"
                  >
                    Tôi đồng ý với{" "}
                    <Link
                      href="/terms"
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full h-11 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-500 hover:to-orange-500 text-white font-bold transition-all hover:scale-[1.02]"
                >
                  {loading ? (
                    <>
