...
const FONT_LINK =
  "https://fonts.googleapis.com/css2?family=Crimson+Pro:italic,wght@0,300;0,400;1,300&family=Cinzel:wght@400;700&display=swap";

// NỘI DUNG CHI TIẾT ĐÃ ĐƯỢC NÂNG CẤP
const chapters = [
  {
    image:
      "https://media.vietnamplus.vn/images/7255a701687d11cb8c6bbc58a6c807858c4156635311d5b65f47f0baf6bd6dbf1fd0d4162223ffc64fe8306b2c4c4d39a74f6b1bfe70b3203772c7979020cefa/tarot-1-9889.jpg",
    title: "Nguồn Gốc",
  ...
  {
    image:
      "https://image.made-in-china.com/365f3j00LhbcQUFGqpqY/In-n-t-y-ch-nh-b-n-bu-n-b-b-i-Tarot-Oracle-b-i-to-n-huy-n-b-nh-m-nh-tr-ch-i-th-tr-ch-i-b-i-in-n-tr-ch-i-b-ng-ch-t-l-ng-cao.webp",
    title: "Bộ Đại Bí Ẩn",
  ...
  {
    image:
      "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjtahZzoYBoDws1TbP7Bzxlalg47eQ4On80V50Ucovct-aqb3BTpfSl33YR3KnDJHqW25wVrKpxhSvJ_2AW0YfM3h6oJtkpXDc1jvXQ71Pxmt44giex7gL8T-Lh5Fw9DChpNYKW_eIv/s1600/les4elements-jpg3.jpeg",
    title: "Bốn Nguyên Tố",
  ...
  {
    image:
      "https://media.istockphoto.com/id/1187328374/vi/anh/ph%C3%B9-th%E1%BB%A7y-s%E1%BB%AD-d%E1%BB%A5ng-m%E1%BB%99t-qu%E1%BA%A3-c%E1%BA%A7u-pha-l%C3%AA-%C4%91%E1%BB%83-d%E1%BB%B1-%C4%91o%C3%A1n-t%C6%B0%C6%A1ng-lai.jpg?s=170667a&w=0&k=20&c=n-HzL1pJ4APw70wmPu31eIfdS94XQEKg4_G1f2nSqq0=",
    title: "Giá Trị Thực",
...
export default function WhatIsTarotPage() {
  ...
  const [activeRawPage, setActiveRawPage] = useState(0);
  ...
  const onFlip = useCallback((e: any) => {
    const rawPage = e.data; // Đây là index trang thực tế từ 0 -> 7
    setActiveRawPage(rawPage);

    // Tính số chương để hiển thị UI (Chương 1, 2, 3, 4)
    const isMobile = window.innerWidth < 768;
    setCurrentStep(Math.floor(rawPage / 2));
  }, []);

  if (!isMounted) return null;

  const totalRawPages = chapters.length * 2; // = 8 trang
  const isFirstPage = activeRawPage === 0;

  // Nút bắt đầu hiện khi ở chương cuối (trang 6 hoặc 7)
  const isLastChapter = activeRawPage >= totalRawPages - 2;
  ...
  return (
    <div className="fixed inset-0 bg-[#070405] text-slate-200 overflow-hidden select-none font-serif">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1578301978018-3005759f48f7?q=80&w=1200&auto=format&fit=crop"
      ...
      <div className="relative z-10 h-screen flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 md:px-10 py-6">
          <Link
            href="/"
            className="group flex items-center gap-2 text-amber-500/40 hover:text-amber-400"
          >
          ...
          <div className="mx-6 text-center">
            ...
            <div className="text-amber-300/20 text-xs tracking-[0.5em]">
              ✦ ✦ ✦
            </div>
          </div>
          <div className="flex-1 h-px bg-gradient-to-l from-transparent to-amber-600/30" />

          <div className="text-amber-500/40 text-[10px] tracking-[0.4em] font-bold uppercase">
            Chương {currentStep + 1} / {chapters.length}
          </div>
        </div>
        ...
        <div className="flex-1 relative flex flex-col items-center justify-center overflow-hidden">
          <div className="relative flex items-center justify-center w-full">
                      ...
                      <div className="w-full h-full flex flex-col justify-start pt-12 space-y-8">
                        <div className="space-y-4">
                          <div className="flex items-center gap-4">
                            ...
                            <span
                              className="text-amber-500/60 text-xs tracking-[0.6em] uppercase font-bold"
                              style={{ fontFamily: "'Cinzel', serif" }}
                            >
                              {ch.subtitle}
                            </span>
                        ...
                        <p
                          className="text-white/70 text-[1.4rem] font-light italic leading-[1.8] text-justify"
            ...
            <button
              ...
              className={`hidden md:block absolute right-4 lg:right-12 z-[60] p-4 text-amber-500/20 hover:text-amber-500 transition-all ${isLastChapter ? "invisible" : ""}`}
            >
        ...
        <div className="h-14 mt-6 md:mt-8 flex items-center justify-center w-full">
          <AnimatePresence>
            {isLastChapter && (
              <motion.div
            ...
            gap-3 md:gap-6 
            px-8 py-3 md:px-16 md:py-5 
            bg-amber-600/15 border border-amber-600/40 text-amber-500 
            rounded-full hover:bg-amber-600 hover:text-black 
            hover:scale-105 transition-all duration-300 
            shadow-[0_0_30px_rgba(245,158,11,0.1)]"
                >
                  <Sparkles className="w-4 h-4 md:w-6 md:h-6 animate-pulse" />
                  <span
                    className="tracking-[0.15em] md:tracking-[0.3em] font-bold text-sm md:text-lg whitespace-nowrap"
                    style={{ fontFamily: "'Cinzel', serif" }}
                  >
                    BẮT ĐẦU TRẢI NGHIỆM
                  </span>
            ...
            {chapters.map((_, i) => (
              <button
                ...
                onClick={() =>
                  bookRef.current
                    ?.pageFlip()
                    .turnToPage(window.innerWidth < 768 ? i : i * 2)
                }
